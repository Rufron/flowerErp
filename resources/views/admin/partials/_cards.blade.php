<div class="grid grid-cols-1 gap-6 mb-6 sm:grid-cols-2 lg:grid-cols-4">
  ...
  <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
    ...
    <p class="mt-3 text-3xl font-bold text-gray-800">56</p>
  </div>
  ...
  <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
    ...
    <p class="mt-3 text-3xl font-bold text-gray-800">$12,430</p>
  </div>
  ...
  <div class="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
    ...
    <p class="mt-3 text-3xl font-bold text-gray-800">1,240</p>
  </div>
